...
const translations = {
  nl: {
    'nav.home': 'Home', 'nav.about': 'Over ons', 'nav.gallery': 'Galerij', 'nav.gallery.location': 'Vestiging', 'nav.gallery.people': 'Mensen', 'nav.gallery.products': 'Diensten', 'nav.gallery.clients': 'Klanten', 'nav.partners': 'Partners', 'nav.news': 'Nieuws', 'nav.contact': 'Contact', 'nav.portal': 'Link portaal',
    ...
    'about.title': 'Alkemade International B.V.', 'about.text1': 'Alkemade International BV is gespecialiseerd in verwerking, marketing en logistiek van verse snijbloemen van over de hele wereld.', 'about.text2': 'Het bedrijf werd opgericht in 1997 en is gevestigd op Royal FloraHolland in Aalsmeer.', 'about.text3': 'Wij bieden een compleet dienstenpakket voor kwekers, exporteurs, importeurs, groothandels en retailers.', 'about.stat1': 'Jaren ervaring', 'about.stat2': 'Partners wereldwijd', 'about.stat3': 'Kwaliteitsgarantie',
    'services.label': 'Onze diensten', 'services.title': 'Compleet dienstenpakket.', 'services.subtitle': 'Wij stellen onze diensten beschikbaar voor kwekers, exporteurs, importeurs, groothandels en retailers.',
    'services.card.unpack.title': 'Uitpakken & Verwerking', 'services.card.unpack.text': 'Professioneel uitpakken en verwerken, inclusief boeketten en mono boeketten voor supermarkten.',
    ...
    'services.card.sales.title': 'Directe Verkoopondersteuning', 'services.card.sales.text': 'Verkoop aan exporteurs of via onze groothandel en webshop.',
    ...
    'gallery.all': 'Alle', 'gallery.location': 'Vestiging', 'gallery.people': 'Mensen', 'gallery.products': 'Diensten', 'gallery.clients': 'Klanten',
    ...
    'about.history.2022.title': 'Overname door J.P. Hogewoning', 'about.history.2022.text': 'In 2022 is Alkemade International B.V. overgenomen door J.P. Hogewoning. Dit zorgde voor een nieuwe start. Alkemade International B.V. specialiseerde zich vanaf dat moment voornamelijk als service provider voor kwekers, groothandels, retailers, importeurs en exporteurs. J.P. Hogewoning heeft de import activiteiten op zich genomen.',
    'about.history.2024.title': 'Nieuw locatie', 'about.history.2024.text': 'In 2024 hebben we alle werkzaamheden van Alkemade International B.V. samengebracht op één plek, onder leiding van een nieuw management. Door deze verhuizing en investeringen in nieuwe productielijnen zijn wij klaar voor de toekomst.',
    'about.history.2026.title': 'Extra service', 'about.history.2026.text': 'Sinds 2026 is het mogelijk om mono bossen en bandboeketten te laten maken. Ook gaan wij slim gebruik maken van AI.',
    'services.page.title': 'Diensten', 'services.page.breadcrumb': 'Diensten', 'services.assortment.label': 'Ons assortiment', 'services.assortment.title': 'Verse snijbloemen van over de hele wereld', 'services.assortment.subtitle': 'Wij verwerken en verhandelen een breed assortiment hoogwaardige bloemen',
    'services.unpack.title': 'Uitpakken & Verwerking', 'services.unpack.text': 'Professioneel uitpakken en verwerken van bloemen bij aankomst, inclusief verwerking van boeketten en mono boeketten voor supermarkten.',
    ...
    'services.request': 'Vraag informatie aan', 'services.photos.label': 'Foto\'s', 'services.photos.title': 'Onze diensten in beeld', 'services.cta.title': 'Interesse in onze diensten?', 'services.cta.text': 'Neem contact met ons op voor meer informatie',
    'location.page.title': 'Vestiging', 'location.page.breadcrumb': 'Vestiging', 'location.label': 'Onze locatie', 'location.title': 'FloraHolland Aalsmeer', 'location.subtitle': 'De grootste bloemenveiling ter wereld',
    ...
    'partners.service.unpack': 'Uitpakken en verwerking', 'partners.service.auction': 'Veilingvoorbereiding', 'partners.service.quality': 'Kwaliteitsfeedback', 'partners.service.financial': 'Financiële rapportage op zendingsniveau', 'partners.service.transport': 'Transport naar veilinglocaties', 'partners.service.sales': 'Directe verkoopondersteuning', 'partners.service.bouquets': 'Boeketten en mono boeketten voor supermarkten',
    'partners.cta.also': 'Wilt u ook partner worden?', 'partners.cta.text2': 'Neem contact met ons op voor een duurzaam partnerschap',
    'people.role.gm': 'General Manager', 'people.role.ops': 'Manager Operations', 'people.role.account': 'Accountmanager', 'people.role.junior': 'Junior Accountmanager', 'people.role.box': 'logistiek coördinator', 'people.role.admin': 'Administratie',
    ...
    'news.article.date': '2026', 'news.article.title': 'Extra service', 'news.article.excerpt': 'Sinds 2026 is het mogelijk om mono bossen en bandboeketten te laten maken. Ook gaan wij slim gebruik maken van AI.',
    'news.modal.title': 'Extra service', 'news.modal.text': 'Sinds 2026 is het mogelijk om mono bossen en bandboeketten te laten maken. Ook gaan wij slim gebruik maken van AI.',
    'clients.global.title': 'Wereldwijde partners', 'clients.global.text': 'Wij werken samen met partners uit verschillende landen. Onze klanten variëren van lokale kwekers tot grote internationale handelaren en retailers.',
  ...
  en: {
    ...
    'about.title': 'Alkemade International B.V.', 'about.text1': 'Alkemade International BV is specialized in handling, marketing and logistics of fresh cut flowers sourced from around the globe.', 'about.text2': 'The company was established in 1997 and is located at Royal FloraHolland in Aalsmeer.', 'about.text3': 'We offer a complete service package for growers, exporters, importers, wholesalers and retailers.', 'about.stat1': 'Years of experience', 'about.stat2': 'Partners worldwide', 'about.stat3': 'Quality guarantee',
    'services.label': 'Our services', 'services.title': 'Complete service package.', 'services.subtitle': 'We make our services available to growers, exporters, importers, wholesalers and retailers.',
    ...
    'services.card.sales.title': 'Direct Sales Support', 'services.card.sales.text': 'Sales to exporters or through our wholesaler and webshop.',
    ...
    'about.history.2022.title': 'Acquisition by J.P. Hogewoning', 'about.history.2022.text': 'In 2022, Alkemade International B.V. was acquired by J.P. Hogewoning. This marked a new beginning. From that moment on, Alkemade International B.V. specialized mainly as a service provider for growers, wholesalers, retailers, importers and exporters. J.P. Hogewoning took over the import activities.',
    'about.history.2024.title': 'New location', 'about.history.2024.text': 'In 2024, we brought all activities of Alkemade International B.V. together in one place, under new management. Through this relocation and investments in new production lines, we are ready for the future.',
    'about.history.2026.title': 'Additional service', 'about.history.2026.text': 'Since 2026, it has been possible to have mono bunches and band bouquets made. We will also make smart use of AI.',
    ...
    'location.page.title': 'Location', 'location.page.breadcrumb': 'Location', 'location.label': 'Our location', 'location.title': 'FloraHolland Aalsmeer', 'location.subtitle': 'The world\'s largest flower auction',
    ...
    'people.role.gm': 'General Manager', 'people.role.ops': 'Manager Operations', 'people.role.account': 'Account Manager', 'people.role.junior': 'Junior Account Manager', 'people.role.box': 'Logistics Coordinator', 'people.role.admin': 'Administration',
    ...
    'news.article.date': '2026', 'news.article.title': 'Additional service',     'news.article.excerpt': 'Since 2026, it has been possible to have mono bunches and band bouquets made. We will also make smart use of AI.',
    'news.modal.title': 'Additional service', 'news.modal.text': 'Since 2026, it has been possible to have mono bunches and band bouquets made. We will also make smart use of AI.',
    'clients.global.title': 'Global partners', 'clients.global.text': 'We work with partners from different countries. Our clients range from local growers to large international traders and retailers.',
  ...
  es: {
    ...
    'about.title': 'Alkemade International B.V.', 'about.text1': 'Alkemade International BV está especializada en procesamiento, marketing y logística de flores cortadas frescas de todo el mundo.', 'about.text2': 'La empresa fue fundada en 1997 y está ubicada en Royal FloraHolland en Aalsmeer.', 'about.text3': 'Ofrecemos un paquete completo de servicios para productores, exportadores, importadores, mayoristas y minoristas.', 'about.stat1': 'Años de experiencia', 'about.stat2': 'Socios en todo el mundo', 'about.stat3': 'Garantía de calidad',
    'services.label': 'Nuestros servicios', 'services.title': 'Paquete completo de servicios.', 'services.subtitle': 'Ponemos nuestros servicios a disposición de productores, exportadores, importadores, mayoristas y minoristas.',
    ...
    'services.card.sales.title': 'Soporte de Ventas Directas', 'services.card.sales.text': 'Ventas a exportadores o a través de nuestro mayorista y tienda en línea.',
    ...
    'about.history.2022.title': 'Adquisición por J.P. Hogewoning', 'about.history.2022.text': 'En 2022, Alkemade International B.V. fue adquirida por J.P. Hogewoning. Esto marcó un nuevo comienzo. A partir de ese momento, Alkemade International B.V. se especializó principalmente como proveedor de servicios para productores, mayoristas, minoristas, importadores y exportadores. J.P. Hogewoning se hizo cargo de las actividades de importación.',
    'about.history.2024.title': 'Nueva ubicación', 'about.history.2024.text': 'En 2024, reunimos todas las actividades de Alkemade International B.V. en un solo lugar, bajo una nueva dirección. A través de esta reubicación e inversiones en nuevas líneas de producción, estamos listos para el futuro.',
    'about.history.2026.title': 'Servicio adicional', 'about.history.2026.text': 'Desde 2026, es posible hacer mono bunches y ramos de banda. También haremos un uso inteligente de la IA.',
    ...
    'location.page.title': 'Ubicación', 'location.page.breadcrumb': 'Ubicación', 'location.label': 'Nuestra ubicación', 'location.title': 'FloraHolland Aalsmeer', 'location.subtitle': 'La subasta de flores más grande del mundo',
    ...
    'people.role.gm': 'Gerente General', 'people.role.ops': 'Gerente de Operaciones', 'people.role.account': 'Gerente de Cuentas', 'people.role.junior': 'Gerente de Cuentas Junior', 'people.role.box': 'Coordinador de Logística', 'people.role.admin': 'Administración',
    ...
    'news.article.date': '2026', 'news.article.title': 'Servicio adicional',     'news.article.excerpt': 'Desde 2026, es posible hacer mono bunches y ramos de banda. También haremos un uso inteligente de la IA.',
    'news.modal.title': 'Servicio adicional', 'news.modal.text': 'Desde 2026, es posible hacer mono bunches y ramos de banda. También haremos un uso inteligente de la IA.',
    'clients.global.title': 'Socios globales', 'clients.global.text': 'Trabajamos con socios de diferentes países. Nuestros clientes van desde productores locales hasta grandes comerciantes internacionales y minoristas.',
