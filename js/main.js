...
const translations = {
  nl: {
    'nav.home': 'Home', 'nav.about': 'Over ons', 'nav.gallery': 'Galerij', 'nav.gallery.location': 'Vestiging', 'nav.gallery.people': 'Mensen', 'nav.gallery.products': 'Producten', 'nav.gallery.clients': 'Klanten', 'nav.partners': 'Partners', 'nav.news': 'Nieuws', 'nav.contact': 'Contact', 'nav.portal': 'Link portaal',
  ...
  en: {
    'nav.home': 'Home', 'nav.about': 'About us', 'nav.gallery': 'Gallery', 'nav.gallery.location': 'Location', 'nav.gallery.people': 'People', 'nav.gallery.products': 'Products', 'nav.gallery.clients': 'Clients', 'nav.partners': 'Partners', 'nav.news': 'News', 'nav.contact': 'Contact', 'nav.portal': 'Link portal',
  ...
  es: {
    'nav.home': 'Inicio', 'nav.about': 'Sobre nosotros', 'nav.gallery': 'Galería', 'nav.gallery.location': 'Ubicación', 'nav.gallery.people': 'Personas', 'nav.gallery.products': 'Productos', 'nav.gallery.clients': 'Clientes', 'nav.partners': 'Socios', 'nav.news': 'Noticias', 'nav.contact': 'Contacto', 'nav.portal': 'Portal de enlaces',
