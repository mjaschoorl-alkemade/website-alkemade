...
const translations = {
  nl: {
    ...
    'partners.cooperation.label': 'Samenwerking', 'partners.cooperation.title': 'Waarom partner worden?', 'partners.cooperation.text': 'Wij bieden een compleet dienstenpakket voor kwekers met focus op perfecte supply chain management.',
  ...
  en: {
    ...
    'partners.cooperation.label': 'Cooperation', 'partners.cooperation.title': 'Why become a partner?', 'partners.cooperation.text': 'We offer a complete service package for growers with focus on perfect supply chain management.',
  ...
  es: {
    ...
    'partners.cooperation.label': 'Cooperación', 'partners.cooperation.title': '¿Por qué convertirse en socio?', 'partners.cooperation.text': 'Ofrecemos un paquete completo de servicios para productores con enfoque en la gestión perfecta de la cadena de suministro.',
