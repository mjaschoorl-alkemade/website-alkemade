...
const translations = {
  nl: {
    ...
    'about.history.2026.title': 'Toekomstbestendig', 'about.history.2026.text': 'In 2026 blijft Alkemade International B.V. zich ontwikkelen in lijn met de tijd. Naast verdere groei en optimalisatie van processen wordt ook kunstmatige intelligentie zorgvuldig omarmd, waar dit veilig en verantwoord kan worden ingezet. AI wordt toegepast ter ondersteuning van het werk, met behoud van menselijke expertise, zonder dat dit ten koste gaat van het personeel of de kwaliteit van dienstverlening. Zo blijft Alkemade bouwen aan een toekomstbestendige organisatie, gebaseerd op vakmanschap, betrouwbaarheid en duurzame samenwerking.',
  ...
  en: {
    ...
    'about.history.2026.title': 'Future-proof', 'about.history.2026.text': 'In 2026, Alkemade International B.V. continues to develop in line with the times. In addition to further growth and optimization of processes, artificial intelligence is also carefully embraced, where it can be safely and responsibly deployed. AI is applied to support the work, while maintaining human expertise, without this being at the expense of staff or the quality of service. This is how Alkemade continues to build a future-proof organization, based on craftsmanship, reliability and sustainable cooperation.',
  ...
  es: {
    ...
    'about.title': 'Alkemade International B.V.', 'about.text1': 'Alkemade International BV es una empresa establecida, especializada en procesamiento, marketing y logística de flores cortadas frescas de todo el mundo, ubicada en FloraHolland Aalsmeer, Países Bajos.', 'about.text2': 'La empresa fue fundada en 1997.', 'about.text3': 'Ofrecemos un paquete completo de servicios no solo para productores, sino también para terceros (exportadores de flores, mayoristas de flores, minoristas), desde desempaque y preparación para subasta hasta retroalimentación de calidad y soporte de ventas directas.', 'about.stat1': 'Años de experiencia', 'about.stat2': 'Socios en todo el mundo', 'about.stat3': 'Garantía de calidad',
    ...
    'about.history.2026.title': 'Preparado para el futuro', 'about.history.2026.text': 'En 2026, Alkemade International B.V. continúa desarrollándose en línea con los tiempos. Además del mayor crecimiento y optimización de procesos, la inteligencia artificial también se adopta cuidadosamente, donde se puede implementar de manera segura y responsable. La IA se aplica para apoyar el trabajo, manteniendo la experiencia humana, sin que esto sea a expensas del personal o la calidad del servicio. Así es como Alkemade continúa construyendo una organización preparada para el futuro, basada en la artesanía, la confiabilidad y la cooperación sostenible.',
