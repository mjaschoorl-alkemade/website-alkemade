...
const translations = {
  nl: {
    ...
    'about.history.2022.title': 'Overname door J.P. Hogewoning', 'about.history.2022.text': 'In 2022 is Alkemade International B.V. overgenomen door J.P. Hogewoning. Dit zorgde voor een nieuwe start. Alkemade International B.V. specialiseerde zich vanaf dat moment voornamelijk als service provider voor groothandels, retailers, importeurs en exporteurs. J.P. Hogewoning heeft de import activiteiten op zich genomen.',
  ...
  en: {
    ...
    'about.history.2022.title': 'Acquisition by J.P. Hogewoning', 'about.history.2022.text': 'In 2022, Alkemade International B.V. was acquired by J.P. Hogewoning. This marked a new beginning. From that moment on, Alkemade International B.V. specialized mainly as a service provider for wholesalers, retailers, importers and exporters. J.P. Hogewoning took over the import activities.',
  ...
  es: {
    ...
    'about.history.2022.title': 'Adquisición por J.P. Hogewoning', 'about.history.2022.text': 'En 2022, Alkemade International B.V. fue adquirida por J.P. Hogewoning. Esto marcó un nuevo comienzo. A partir de ese momento, Alkemade International B.V. se especializó principalmente como proveedor de servicios para mayoristas, minoristas, importadores y exportadores. J.P. Hogewoning se hizo cargo de las actividades de importación.',
