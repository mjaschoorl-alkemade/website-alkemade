...
const translations = {
  nl: {
    ...
    'about.history.2022.title': 'Verkocht aan JP Hogewoning', 'about.history.2022.text': 'In 2022 is Alkemade International B.V. verkocht aan JP Hogewoning. Dit was een belangrijk moment voor het bedrijf en zorgde voor een nieuwe start.',
    'about.history.2024.title': 'Nieuw hoofdkantoor', 'about.history.2024.text': 'In 2024 hebben we alle kantoren samengebracht op één plek. We hebben een gloednieuw hoofdkantoor gebouwd en flink geïnvesteerd in nieuwe samenwerkingspartners en productielijnen. Zo konden we efficiënter gaan werken.',
    'about.history.2026.title': 'Nieuwe dienst: Mono bossen en bandboeketten', 'about.history.2026.text': 'Vanaf februari 2026 gaan we mono bossen en bandboeketten maken voor kwekers en anderen. Dit is een helemaal nieuwe service voor ons. We gaan ook slim gebruikmaken van AI om dit goed te doen. Het belangrijkste is dat we ons team behouden en goed voor iedereen zorgen. We willen graag groeien, maar niet ten koste van onze medewerkers.',
    ...
    'news.article.date': 'Februari 2026', 'news.article.title': 'Nieuwe dienst: Mono bossen en bandboeketten', 'news.article.excerpt': 'Wij starten vanaf Februari 2026 met het maken van mono bossen en bandboeketten voor kwekers, groothandelaren en retailers.',
    'news.modal.title': 'Nieuwe dienst: Mono bossen en bandboeketten', 'news.modal.text': 'Wij starten vanaf Februari 2026 met het maken van mono bossen en bandboeketten voor kwekers, groothandelaren en retailers.',
  ...
  en: {
    ...
    'about.history.2022.title': 'Sold to JP Hogewoning', 'about.history.2022.text': 'In 2022, Alkemade International B.V. was sold to JP Hogewoning. This was an important moment for the company and marked a new beginning.',
    'about.history.2024.title': 'New headquarters', 'about.history.2024.text': 'In 2024, we brought all offices together in one place. We built a brand new headquarters and made significant investments in new collaboration partners and production lines. This allowed us to work more efficiently.',
    'about.history.2026.title': 'New service: Mono bunches and band bouquets', 'about.history.2026.text': 'Starting in February 2026, we will make mono bunches and band bouquets for growers and others. This is a completely new service for us. We will also make smart use of AI to do this well. The most important thing is that we retain our team and take good care of everyone. We want to grow, but not at the expense of our employees.',
  ...
  es: {
    ...
    'about.history.2022.title': 'Vendido a JP Hogewoning', 'about.history.2022.text': 'En 2022, Alkemade International B.V. fue vendida a JP Hogewoning. Este fue un momento importante para la empresa y marcó un nuevo comienzo.',
    'about.history.2024.title': 'Nueva sede', 'about.history.2024.text': 'En 2024, reunimos todas las oficinas en un solo lugar. Construimos una sede completamente nueva e hicimos importantes inversiones en nuevos socios colaboradores y líneas de producción. Esto nos permitió trabajar de manera más eficiente.',
    'about.history.2026.title': 'Nuevo servicio: Mono bunches y ramos de banda', 'about.history.2026.text': 'A partir de febrero de 2026, fabricaremos mono bunches y ramos de banda para productores y otros. Este es un servicio completamente nuevo para nosotros. También haremos un uso inteligente de la IA para hacerlo bien. Lo más importante es que conservamos nuestro equipo y cuidamos bien de todos. Queremos crecer, pero no a costa de nuestros empleados.',
