...
const searchData = {
  nl: {
    ...
    faq: [
      ...
      { q: ['team', 'mensen', 'wie werken er', 'medewerkers'], a: 'Ons team bestaat uit ervaren professionals: Mark Schoorl (General Manager), Bartek Liskowski (Manager Operations), Claudia Alkemade (Accountmanager), Aleksandra Wolska (Junior Accountmanager), Mike Hofman (logistiek coördinator) en Anna Anderlova (Administratie).', url: 'mensen.html', context: 'bedrijf' }
    ]
  },
  en: {
    ui: {
