...
const searchData = {
  nl: {
    ...
    pages: [
      ...
      { title: 'Nieuws', url: 'nieuws.html', keywords: ['nieuws', 'updates', 'artikelen', 'laatste nieuws'], content: 'Laatste nieuws en updates van Alkemade Flowers International. Vanaf Februari 2026 starten wij met het maken van mono bossen en bandboeketten voor kwekers en/of derden.', category: 'nieuws' },
    ...
    faq: [
      ...
      { q: ['diensten', 'services', 'wat bieden jullie', 'wat doen jullie', 'welke diensten'], a: 'Wij bieden een compleet dienstenpakket niet alleen voor kwekers, maar ook voor derden (exporteurs van bloemen, groothandels in bloemen, retailers). Onze diensten omvatten: uitpakken & verwerking, veilingvoorbereiding, kwaliteitsfeedback, financiële rapportage op zendingsniveau, transport naar veilinglocaties met beheerde koelketen, en directe verkoopondersteuning. Ook verwerken wij boeketten en mono bunches voor supermarkten.', url: 'services.html', context: 'diensten' },
      ...
      { q: ['boeketten', 'supermarkt', 'mono bunches', 'bandboeketten', 'mono bossen'], a: 'Wij verwerken boeketten en mono bunches voor supermarkten. Vanaf Februari 2026 starten wij ook met het maken van mono bossen en bandboeketten voor kwekers en/of derden. Dit is een nieuwe service die wij toevoegen aan ons dienstenpakket.', url: 'services.html', context: 'diensten' },
  ...
  en: {
    ...
    pages: [
      ...
      { title: 'News', url: 'nieuws.html', keywords: ['news', 'updates', 'articles', 'latest news'], content: 'Latest news and updates from Alkemade Flowers International. Starting February 2026, we will begin making mono bunches and band bouquets for growers and/or third parties.', category: 'news' },
    ...
    faq: [
      ...
      { q: ['bouquets', 'supermarket', 'mono bunches', 'band bouquets', 'mono bunches'], a: 'We process bouquets and mono bunches for supermarkets. Starting February 2026, we will also begin making mono bunches and band bouquets for growers and/or third parties. This is a new service we are adding to our service package.', url: 'services.html', context: 'services' },
  ...
  es: {
    ...
    pages: [
      ...
      { title: 'Noticias', url: 'nieuws.html', keywords: ['noticias', 'actualizaciones', 'artículos', 'últimas noticias'], content: 'Últimas noticias y actualizaciones de Alkemade Flowers International. A partir de febrero de 2026, comenzaremos a fabricar mono bunches y ramos de banda para productores y/o terceros.', category: 'noticias' },
    ...
    faq: [
      ...
      { q: ['ramos', 'supermercado', 'mono bunches', 'ramos de banda', 'mono bunches'], a: 'Procesamos ramos y mono bunches para supermercados. A partir de febrero de 2026, también comenzaremos a fabricar mono bunches y ramos de banda para productores y/o terceros. Este es un nuevo servicio que estamos agregando a nuestro paquete de servicios.', url: 'services.html', context: 'servicios' },
