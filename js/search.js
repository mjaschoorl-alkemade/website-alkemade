...
const searchData = {
  nl: {
    ...
    pages: [
      ...
      { title: 'Nieuws', url: 'nieuws.html', keywords: ['nieuws', 'updates', 'artikelen', 'laatste nieuws'], content: 'Laatste nieuws en updates van Alkemade Flowers International. Vanaf Februari 2026 starten wij met het maken van mono bossen en bandboeketten voor kwekers, groothandelaren en retailers.', category: 'nieuws' },
    ...
    faq: [
      ...
      { q: ['boeketten', 'supermarkt', 'mono boeketten', 'bandboeketten', 'mono bossen'], a: 'Wij verwerken boeketten en mono boeketten voor supermarkten. Vanaf Februari 2026 starten wij ook met het maken van mono bossen en bandboeketten voor kwekers, groothandelaren en retailers. Dit is een nieuwe dienst die wij toevoegen aan ons dienstenpakket.', url: 'services.html', context: 'diensten' },
